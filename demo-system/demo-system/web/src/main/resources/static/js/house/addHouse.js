$(function () {
    ...
    $("#saleTime").datetimepicker("setDate", new Date());
    ...
    $("#commitTime").datetimepicker("setDate", new Date());

    validateForm();

    $("#addHouseForm").submit(function (ev) {
        ev.preventDefault();
    });
    $("#validaterBtn").on("click", function () {
        ...
        if ($("#addHouseForm").data('bootstrapValidator').isValid()) {
            $('#myModal').modal('show');
            $("#continueBtn").on("click", function () {
                $('#myModal').modal('hide');
                $('#myModal').attr('aria-hidden', false);
                $('#saleTimeStamp').val($('#saleTime').datetimepicker('getDate').getTime());
                $('#commitTimeStamp').val($('#commitTime').datetimepicker('getDate').getTime());
                ...
                var entity = new FormData($('#addHouseForm')[0]);
...
function validateForm() {
    $('#addHouseForm').bootstrapValidator({
